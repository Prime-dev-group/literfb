package com.prime.superlitefb.activity;
...
//        OneSignal.setLogLevel(OneSignal.LOG_LEVEL.DEBUG, OneSignal.LOG_LEVEL.DEBUG);
        ...
        if (preferences.getBoolean("first_run", true)) {
            // code that u can add to run for the first time
        ...
        if (preferences.getBoolean("notifications_activated", true) || preferences.getBoolean("message_notifications", true)) {
        ...
        // Tor proxy
        final Proxy proxy = Misc.getProxy(preferences);
        ...
        // code optimization
        boolean isConnectedMobile = CheckConnection.isConnectedMobile(getApplicationContext());
...
//        if (!CheckConnection.isConnected(this) && !preferences.getBoolean("offline_mode", false))
//            Toast.makeText(getApplicationContext(), getString(R.string.no_network), Toast.LENGTH_SHORT).show();

        if (!CheckConnection.isConnected(getApplicationContext()) && !preferences.getBoolean("offline_mode", false)){
    ...
    private final SwipeRefreshLayout.OnRefreshListener onRefreshListener = new SwipeRefreshLayout.OnRefreshListener() {
        ...
        public void onRefresh() {
            ...
            if (preferences.getBoolean("offline_mode", false) && !CheckConnection.isConnected(getApplicationContext()))
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (preferences.getBoolean("facebook_zero", false) && CheckConnection.isConnectedMobile(getApplicationContext()))
    ...
    private void selectItem(int position, String baseAddress) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                if (preferences.getBoolean("facebook_zero", false) && CheckConnection.isConnectedMobile(this)) {
                    Toast.makeText(getApplicationContext(), getString(R.string.facebook_zero_active), Toast.LENGTH_SHORT).show();
                    break;
                }
                webView.getSettings().setUserAgentString(MainActivity.USER_AGENT_MESSENGER);
            ...
            case 5:
                //for rating
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.prime.superlitefb")));
                break;
            case 6:
...
//            Toast.makeText(getApplicationContext(), getString(R.string.no_network), Toast.LENGTH_SHORT).show();
    ...
    private void saveImageToDisk(String imageUrl) {
        ...
        try {
            ...
            String file = "litefb-saved-image-" + date.replace(" ", "").replace(":", "").replace(".", "") + imgExtension;
    ...
    private void addLauncherShortcut() {
        final Intent shortcut = new Intent(this, CustomActivityShort.class);
        shortcut.putExtra(CustomActivityShort.URL_FIELD, webView.getUrl());
        ...
        builder.setPositiveButton(getString(android.R.string.ok), new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                shortcut.putExtra(CustomActivityShort.NAME_FIELD, label);
